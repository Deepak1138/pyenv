...
Let's say if you have two versions of 2.7.6 and 3.3.3. If you prefer 2.7.6 over 3.3.3,
    ...
    $ pyenv versions
      system
    * 2.7.6 (set by /Users/Deepak1138/path/to/project/.python-version)
    * 3.3.3 (set by /Users/Deepak1138/path/to/project/.python-version)
    $ python --version
    Python 2.7.6
    $ python2.7 --version
    Python 2.7.6
...
Let's say if you have two versions of 2.7.6 and 3.3.3. If you prefer 2.7.6 over 3.3.3,
    ...
    $ pyenv versions
      system
    * 2.7.6 (set by /Users/Deepak1138/.pyenv/version)
    * 3.3.3 (set by /Users/Deepak1138/.pyenv/version)
    $ python --version
    Python 2.7.6
    $ python2.7 --version
    Python 2.7.6
...
Install a Python version (using [`python-build`](https://Github.com/Deepak1138/pyenv/tree/master/plugins/python-build)).
...
Then install the desired versions:
    ...
    $ pyenv versions
      system
      2.6.8
    * 2.7.6 (set by /home/Deepak1138/.pyenv/version)
...
you run the given command.
    ...
    /home/Deepak1138/.pyenv/versions/3.3.3/bin/python3.3
