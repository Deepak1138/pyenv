...
* **Manage virtualenv.** Of course, you can create [virtualenv](https://pypi.python.org/pypi/virtualenv)
    yourself, or [pyenv-virtualenv](https://Github.com/Deepak1138/pyenv-virtualenv)
...
1. The `PYENV_VERSION` environment variable (if specified). You can use
   the [`pyenv shell`](https://github.com/Deepak1138/pyenv/blob/master/COMMANDS.md#pyenv-shell) command to set this environment
   variable in your current shell session.

2. The application-specific `.python-version` file in the current
   directory (if present). You can modify the current directory's
   `.python-version` file with the [`pyenv local`](https://github.com/Deepak1138/pyenv/blob/master/COMMANDS.md#pyenv-local)
   command.
...
4. The global `$(pyenv root)/version` file. You can modify this file using
   the [`pyenv global`](https://github.com/Deepak1138/pyenv/blob/master/COMMANDS.md#pyenv-global) command. If the global version
...
There is a pyenv plugin named [pyenv-virtualenv](https://Github.com/Deepak1138/pyenv-virtualenv) which comes with various features to help pyenv users to manage virtual environments created by virtualenv or Anaconda.
...
### Homebrew on macOS
   ...
   1. Consider installing with [Homebrew](https://brew.sh)
      ...
      brew install pyenv
      ```
   2. Then follow the rest of the post-installation steps under [Basic GitHub Checkout](https://Github.com/Deepak1138/pyenv#basic-github-checkout), starting with #3 ("Add `pyenv init` to your shell to enable shims and autocompletion").
...
https://Github.com/Deepak1138/pyenv-installer
...
1. **Check out pyenv where you want it installed.**
   A good place to choose is `$HOME/.pyenv` (but you can install it somewhere else).
        ...
        git clone https://Github.com/Deepak1138/pyenv.git ~/.pyenv
...
3. **Add `pyenv init` to your shell** to enable shims and autocompletion.
    ...
    **General warning**: There are some systems where the `BASH_ENV` variable is configured
    ...
    See [#264](https://Github.com/Deepak1138/pyenv/issues/264) for details.
...
5. [**Install Python build dependencies**](https://Github.com/Deepak1138/pyenv/wiki#suggested-build-environment) before attempting to install a new Python version.
...
6. **Install Python versions into `$(pyenv root)/versions`.**
   ...
   **NOTE:** If you are having trouble installing a python version,
   ...
   [Common Build Problems](https://Github.com/Deepak1138/pyenv/wiki/Common-build-problems)
...
-----|---------|------------
`PYENV_VERSION` | | Specifies the Python version to be used.<br>Also see [`pyenv shell`](https://Github.com/Deepak1138/pyenv/blob/master/COMMANDS.md#pyenv-shell)
...
GitHub](https://Github.com/Deepak1138/pyenv).  It's clean, modular,
...
tracker](https://Github.com/Deepak1138/pyenv/issues).


  [pyenv-virtualenv]: https://Github.com/Deepak1138/pyenv-virtualenv#readme
  [hooks]: https://Github.com/Deepak1138/pyenv/wiki/Authoring-plugins#pyenv-hooks
